...
public class CashierTest extends TestCase
{
	...
	/**
	 * Test cashier paying two markets. Cashier only has $10 to start. Market bills total $25
	 */
	public void testFiveNormalTwoMarketScenario()
	{
		...
		//check preconditions
		assertEquals("Cashier should have 10 dollars in it. It doesn't.", cashier.getMoney(), 10.0);		
		assertEquals("CashierAgent should have an empty event log before the Cashier's HereIsBill is called. Instead, the Cashier's event log reads: "
						+ cashier.log.toString(), 0, cashier.log.size());
		
		cashier.msgMarketBill(market1, 20);
		
		assertTrue("Cashier should have logged \"Received msgMarketBill market1 total = 10\" but didn't. His log reads instead: " 
		...
		assertTrue("Cashier should have logged \"Scheduler called payMarketBill market1\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Scheduler called payMarketBill market1"));
		
		assertTrue("Cashier should have logged \"Bill paid in full.\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Some of bill paid."));
		
		
		
		///////////		
		assertTrue("Market should have logged \"Recieved msgHereIsPayment total =10\" but didn't. His log reads instead: " 
		...
		assertTrue("Cashier should have logged \"Scheduler called payMarketBill market2\" but didn't. His log reads instead: " 
		...
		assertTrue("Market should have logged \"Recieved msgHereIsPayment total =5\" but didn't. His log reads instead: " 
	 ...
	 * 		one market. Cashier has enough money pays market.
	 */
	public void testTwoNormalOneMarketScenario()
	{
		...
		assertTrue("Cashier should have logged \"Received msgMarketBill market1 total = 5\" but didn't. His log reads instead: " 
	 ...
	 * 		one market. Cashier does NOT have enough money to pay market.
	 */
	public void testThreeNonNormalOneMarketScenario()
	{
		...
		assertTrue("Cashier should have logged \"Received msgMarketBill market1 total = 15\" but didn't. His log reads instead: " 
	...
	/**This tests non-normal market cashier interactions
	 * 		one market. Cashier does NOT have any money.
	 */
	public void testFourNonNormalOneMarketScenario()
	{
		...
		//check preconditions
		assertEquals("Cashier should have 10 dollars in it. It doesn't.", cashier.getMoney(), 0.0);		
		assertEquals("CashierAgent should have an empty event log before the Cashier's HereIsBill is called. Instead, the Cashier's event log reads: "
						+ cashier.log.toString(), 0, cashier.log.size());
		...
		assertEquals("Market should have no logs. His log reads instead: " 
	...
	public void testOneNormalCustomerScenario()
	{
		...
		assertTrue("Cashier should have logged \"Scheduler called computeBill\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Scheduler called computeBill"));
		
		
		assertTrue(
				"MockWaiter should have an event log  msgHereIsCheck recieved after the Cashier's scheduler is called for the first time. Instead, the MockWaiter's event log reads: "
		...
		assertTrue("Cashier should have logged \"Recieved msgHereIsPayment: 4\" but didn't. His log reads instead: " 
		...
		assertTrue("Cashier should have logged \"Scheduler called computeChange 4\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Scheduler called computeChange 4"));
		
		assertTrue("Cashier should have logged \"Change = 2 Total = 0\" but didn't. His log reads instead: " 
		...
		assertTrue("Cashier should have $12", cashier.getMoney() == 12);
	...
	public void testSixNormalCustomerMarketScenario()
	{
		...
		assertTrue("Cashier should have logged \"Received msgMarketBill market2 total = 10\" but didn't. His log reads instead: " 
		...
		//step 4 pay MARKET1
		assertTrue("Cashier's scheduler should have returned true (need to pay market), but didn't.", 
				cashier.pickAndExecuteAnAction());
		//check preconditions
		assertTrue("Cashier should have logged \"Scheduler called payMarketBill market1\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Scheduler called payMarketBill market1"));
		...
		assertTrue("Cashier should have logged \"Scheduler called payMarketBill market1\" but didn't. His log reads instead: " 
			+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Scheduler called payMarketBill market2"));
				...
				assertTrue("Market should have logged \"Recieved msgHereIsPayment total =2.0\" but didn't. His log reads instead: " 
