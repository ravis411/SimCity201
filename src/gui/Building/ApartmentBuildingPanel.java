...
public class ApartmentBuildingPanel extends BuildingPanel{
	...
	public ApartmentBuildingPanel(Rectangle2D r, String name, BuildingsPanels buildingPanels, SetUpWorldFactory factory) {
		...
		//Apartment 1
				...
				addBuilding("Residence", "Apartment 1", 0, 0, 50, 50, location);
		...
		//Apartment 2
				...
				location.entranceFromRoadGrid = location.positionToEnterFromRoadGrid = null;
				addBuilding("Residence", "Apartment 2", 0, 200, 50, 50, location);
		...
		//Apartment 3
				...
				location.entranceFromRoadGrid = location.positionToEnterFromRoadGrid = null;
				addBuilding("Residence", "Apartment 3", 500, 0, 50, 50, location);
		...
		//Apartment 4
				...
				location.entranceFromRoadGrid = location.positionToEnterFromRoadGrid = null;
				addBuilding("Residence", "Apartment 4", 500, 200, 50, 50, location);
