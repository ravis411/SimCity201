...
import restaurant.luca.LucaWaiterRole.Order;
...
public class RevolvingStand {
	 ...
	 * @param t the Table
	 */
	public synchronized void addOrder(GenericWaiter w, String choice, int table){
		orders.add(new Order((LucaWaiterRole) w, choice, table));
	}
